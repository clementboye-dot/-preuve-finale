...
# Paramètres de gestion du comportement de la caméra
var vitesse_translation : float = 10.0
var vitesse_rotation : float = 1.0
var pitch_min : float = -89.0
var pitch_max : float = 89.0
